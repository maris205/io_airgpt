...
ARK_API_KEY = "YOUR_IO_API_KEY" # your api key, visit https://api.intelligence.io.solutions/api/v1 api
...
sysprompt = open(system_prompts, "r", encoding="utf8").read()
chat_history.append(
{
"role": "system",
"content": sysprompt,
