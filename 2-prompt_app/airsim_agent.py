...
ARK_API_KEY = "YOUR_IO_API_KEY" # your api key, visit https://api.intelligence.io.solutions/api/v1 to get API access
...
class AirSimAgent:
    def __init__(self, system_prompts="system_prompts/airsim_basic_cn.txt", knowledge_prompt="prompts/airsim_basic_cn.txt", chat_history=[]):
        ...
        # Knowledge base: add to chat history via the chat function
    ...
    def ask(self, prompt):
        ...
        # Add assistant reply to preserve full history for multi-turn conversation
        self.chat_history.append(
            {
                "role": "assistant",
                "content": content,
