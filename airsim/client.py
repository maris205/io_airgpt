...
self.client.call('myPrint', text)

def addFlightPip(self, name, pose, scale, color, cube = True):
self.client.call('addFlightPip', name, pose, scale, color, cube)

def delFlightPip(self, name):
self.client.call('delFlightPip', name)

# new 
def addLandingPort(self, port_name, location, box_num) -> bool:
return self.client.call('addLandingPort', port_name, location, box_num)

#delete
def delLandingPort(self, port_name) -> bool:
return self.client.call('delLandingPort', port_name)

#check has 
def getBoxesNumber(self, port_name) -> int:
return self.client.call('getBoxesNumber', port_name)

#set
def setBoxesNumber(self, port_name, box_num) -> bool:
return self.client.call('setBoxesNumber', port_name, box_num)

#
def pickBox(self, drone_name, port_name) -> bool:
return self.client.call('pickBox', drone_name, port_name)

# below 
def dropBox(self, drone_name, port_name) -> bool:
return self.client.call('dropBox', drone_name, port_name)

#getdrone state
def getPickedStatus(self, drone_name) -> bool:
return self.client.call('getPickedStatus', drone_name)
